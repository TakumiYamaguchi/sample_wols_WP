...
function add_front_page_tab_label( $tab_labels ) {
	$tab_labels['front_page'] = __( 'Front page', 'tcd-horizon' );
	return $tab_labels;
}
...
function add_front_page_dp_default_options( $dp_default_options ) {
  ...
  // コンテンツビルダー
	$dp_default_options['contents_builder'] = array(
		array(
			"cb_content_select" => "image_slider",
			"show_content" => 1,
			"layout" => "type1",
			"item_list" => array(
    			array(
        			"image" => "",
        			"image_mobile" => "",
        			"overlay_color" => "#032a38",
        			"overlay_opacity" => "0.5",
        			"catch" => __( 'Catchphrase', 'tcd-horizon' ),
        			"catch_font_type" => "type3",
        			"catch_font_size" => "40",
        			"catch_font_size_sp" => "24",
        			"desc" => __( 'Description will be displayed here.<br>Description will be displayed here.', 'tcd-horizon' ),
        			"show_button" => "1",
        			"button_type" => "type2",
		...
		array(
			...
			"image4" => "",
			"image_mobile4" => "",
			"button_border_raidus3" => "",
			"button_size3" => "",
			"button_animation_type3" => ""
		),
		array(
			"cb_content_select" => "design_content",
			"show_content" => 1,
			...
			"headline2" => "WORK",
			"catch2" => "",
			"desc2" => __( 'Description will be displayed here.<br>Description will be displayed here.', 'tcd-horizon' ),
			"show_button2" => 0,
			"button_label2" => "BUTTON",
			"button_url2" => "",
			"font_color2" => "#ffffff",
   ...
   <div class="contents_builder_wrap">
    ...
    <div class="contents_builder-clone hidden">
     ...
     <?php
          ...
          the_cb_content_setting('cb_cloneindex', 'image_slider');
          the_cb_content_setting('cb_cloneindex', 'box_content');
          the_cb_content_setting('cb_cloneindex', 'access_map');
...
<?php
     ...
     if ($cb_content_select == 'design_content') {
       ...
       if (!isset($value['catch_font_size3'])) { $value['catch_font_size3'] = '40'; }
       if (!isset($value['catch_font_size_sp3'])) { $value['catch_font_size_sp3'] = '24'; }
       ...
       if (!isset($value['image_mobile1'])) { $value['image_mobile1'] = ''; }
       if (!isset($value['image_mobile2'])) { $value['image_mobile2'] = ''; }
       if (!isset($value['image_mobile3'])) { $value['image_mobile3'] = ''; }
       if (!isset($value['image_mobile4'])) { $value['image_mobile4'] = ''; }
...
?>
  ...
  <div class="cb_content">
   ...
   <p class="displayment_checkbox"><label><input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_content]" type="checkbox" value="1" <?php checked( $value['show_content'], 1 ); ?>> <?php _e('Display design content', 'tcd-horizon'); ?></label></p>
   ...
   <ul class="design_radio_button2 cb_layout_option" style="margin-bottom:30px;">
    ...
    <li<?php if($value['layout'] == 'type'.$i){ echo ' class="active"'; }; ?>>
     <label class="cb_layout_option_type<?php echo $i; ?>" for="cb_layout_type<?php echo $i; ?>_<?php echo $cb_index; ?>">
      ...
      <input type="radio" id="cb_layout_type<?php echo $i; ?>_<?php echo $cb_index; ?>" name="dp_options[contents_builder][<?php echo $cb_index; ?>][layout]" value="type<?php echo $i; ?>" <?php checked( $value['layout'], 'type'.$i ); ?> />
     </label>
    </li>
    <?php endfor; ?>
   </ul>
    ...
    <div class="sub_box_content">
     ...
     <div class="cf" style="margin-top:20px;">
      <div class="standard_radio_button">
       <input type="radio" id="catch_type2_type1_<?php echo $cb_index; ?>" name="dp_options[contents_builder][<?php echo $cb_index; ?>][catch_type2]" value="type1"<?php checked( $value['catch_type2'], 'type1' ); ?>>
       <label class="catch_type_type1_button" for="catch_type2_type1_<?php echo $cb_index; ?>"><?php _e('Headline', 'tcd-horizon');  ?></label>
       <input type="radio" id="catch_type2_type2_<?php echo $cb_index; ?>" name="dp_options[contents_builder][<?php echo $cb_index; ?>][catch_type2]" value="type2"<?php checked( $value['catch_type2'], 'type2' ); ?>>
       <label class="catch_type_type2_button" for="catch_type2_type2_<?php echo $cb_index; ?>"><?php _e('Catchphrase', 'tcd-horizon');  ?></label>
      </div>
     </div>
     <br class="clear">

     <input type="text" class="catch_type1_area full_width cb-repeater-label" name="dp_options[contents_builder][<?php echo $cb_index; ?>][headline2]" value="<?php echo esc_html(  $value['headline2'] ); ?>" />
     <textarea class="catch_type2_area full_width" cols="50" rows="3" name="dp_options[contents_builder][<?php echo $cb_index; ?>][catch2]"><?php echo esc_textarea(  $value['catch2'] ); ?></textarea>

     <h4 class="theme_option_headline2"><?php _e('Description', 'tcd-horizon');  ?></h4>
     <textarea class="large-text" cols="50" rows="3" name="dp_options[contents_builder][<?php echo $cb_index; ?>][desc2]"><?php echo esc_textarea(  $value['desc2'] ); ?></textarea>
     ...
     <div class="hide_when_type5">
      ...
      <p class="displayment_checkbox"><label><input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_button2]" type="checkbox" value="1" <?php checked( $value['show_button2'], 1 ); ?>><?php _e( 'Display button', 'tcd-horizon' ); ?></label></p>
      <div class="button_option_area" style="<?php if($value['show_button2'] == 1) { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
       <ul class="option_list">
        <li class="cf" style="border-top:1px dotted #ccc;"><span class="label"><?php _e('label', 'tcd-horizon');  ?></span><input class="full_width" type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][button_label2]" value="<?php esc_attr_e( $value['button_label2'] ); ?>" /></li>
        <li class="cf"><span class="label"><?php _e('URL', 'tcd-horizon');  ?></span><input class="full_width" type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][button_url2]" value="<?php esc_attr_e( $value['button_url2'] ); ?>" /></li>
       </ul>
      </div>
     </div>
     ...
     <ul class="option_list">
      <li class="cf"><span class="label"><?php _e('Font color', 'tcd-horizon'); ?></span><input type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][font_color2]" value="<?php echo esc_attr( $value['font_color2'] ); ?>" data-default-color="#ffffff" class="c-color-picker"></li>
      <li class="cf"><span class="label"><?php _e('Background color', 'tcd-horizon'); ?></span><input type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][bg_color2]" value="<?php echo esc_attr( $value['bg_color2'] ); ?>" data-default-color="#000000" class="c-color-picker"></li>
     </ul>
   ...
   <div class="sub_box cf"> 
    ...
    <div class="sub_box_content">
     ...
     <div class="background_type_option">
      ...
      <ul class="design_radio_button horizontal cf">
       <li class="cb_bg_type_type1">
        <input type="radio" id="bg_type1_<?php echo $cb_index; ?>" name="dp_options[contents_builder][<?php echo $cb_index; ?>][bg_type]" value="type1" <?php checked( $value['bg_type'], 'type1' ); ?> />
        <label for="bg_type1_<?php echo $cb_index; ?>"><?php _e('Image', 'tcd-horizon'); ?></label>
       </li>
       <li class="cb_bg_type_type2">
        <input type="radio" id="bg_type2_<?php echo $cb_index; ?>" name="dp_options[contents_builder][<?php echo $cb_index; ?>][bg_type]" value="type2" <?php checked( $value['bg_type'], 'type2' ); ?> />
        <label for="bg_type2_<?php echo $cb_index; ?>"><?php _e('Video', 'tcd-horizon'); ?></label>
       </li>
       <li class="cb_bg_type_type3">
        <input type="radio" id="bg_type3_<?php echo $cb_index; ?>" name="dp_options[contents_builder][<?php echo $cb_index; ?>][bg_type]" value="type3" <?php checked( $value['bg_type'], 'type3' ); ?> />
     ...
     <div class="video_bg_option">
      ...
      <div class="image_box cf">
       <div class="cf cf_media_field hide-if-no-js video_<?php echo $cb_index; ?>">
        <input type="hidden" value="<?php echo esc_attr( $value['video'] ); ?>" id="video_<?php echo $cb_index; ?>" name="dp_options[contents_builder][<?php echo $cb_index; ?>][video]" class="cf_media_id">
     ...
     <div class="youtube_bg_option">
      ...
      <input class="regular-text" type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][youtube]" value="<?php echo esc_attr( $value['youtube'] ); ?>">
      ...
      <li class="cf">
       ...
       <div class="image_box cf">
        <div class="cf cf_media_field hide-if-no-js image-<?php echo $cb_index; ?>1">
         <input type="hidden" class="cf_media_id" name="dp_options[contents_builder][<?php echo $cb_index; ?>][image1]" id="image-<?php echo $cb_index; ?>1" value="<?php echo esc_attr( $value['image1'] ); ?>">
      ...
      <li class="cf image_bg_option">
       ...
       <div class="image_box cf">
        <div class="cf cf_media_field hide-if-no-js image_mobile-<?php echo $cb_index; ?>1">
         <input type="hidden" class="cf_media_id" name="dp_options[contents_builder][<?php echo $cb_index; ?>][image_mobile1]" id="image_mobile-<?php echo $cb_index; ?>1" value="<?php echo esc_attr( $value['image_mobile1'] ); ?>">
      ...
      <li class="cf image_option2" style="border-top:1px dotted #ccc;">
       ...
       <div class="image_box cf">
        <div class="cf cf_media_field hide-if-no-js image-<?php echo $cb_index; ?>2">
         <input type="hidden" class="cf_media_id" name="dp_options[contents_builder][<?php echo $cb_index; ?>][image2]" id="image-<?php echo $cb_index; ?>2" value="<?php echo esc_attr( $value['image2'] ); ?>">
      ...
      <li class="cf image_option2">
       ...
       <div class="image_box cf">
        <div class="cf cf_media_field hide-if-no-js image_mobile-<?php echo $cb_index; ?>2">
         <input type="hidden" class="cf_media_id" name="dp_options[contents_builder][<?php echo $cb_index; ?>][image_mobile2]" id="image_mobile-<?php echo $cb_index; ?>2" value="<?php echo esc_attr( $value['image_mobile2'] ); ?>">
      ...
      <li class="cf image_option3">
       ...
       <div class="image_box cf">
        <div class="cf cf_media_field hide-if-no-js image-<?php echo $cb_index; ?>3">
         <input type="hidden" class="cf_media_id" name="dp_options[contents_builder][<?php echo $cb_index; ?>][image3]" id="image-<?php echo $cb_index; ?>3" value="<?php echo esc_attr( $value['image3'] ); ?>">
      ...
      <li class="cf image_option3">
       ...
       <div class="image_box cf">
        <div class="cf cf_media_field hide-if-no-js image_mobile-<?php echo $cb_index; ?>3">
         <input type="hidden" class="cf_media_id" name="dp_options[contents_builder][<?php echo $cb_index; ?>][image_mobile3]" id="image_mobile-<?php echo $cb_index; ?>3" value="<?php echo esc_attr( $value['image_mobile3'] ); ?>">
     ...
     <div class="para_option">
      ...
      <p><label><input class="use_para_checkbox" name="dp_options[contents_builder][<?php echo $cb_index; ?>][use_para]" type="checkbox" value="1" <?php checked( $value['use_para'], 1 ); ?>><?php _e( 'Use parallax effect', 'tcd-horizon' ); ?></label></p>
     </div>
     ...
     <ul class="option_list">
      <li class="cf"><span class="label"><?php _e('Color of overlay', 'tcd-horizon'); ?></span><input type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][overlay_color]" value="<?php echo esc_attr( $value['overlay_color'] ); ?>" data-default-color="#000000" class="c-color-picker"></li>
      <li class="cf">
       <span class="label"><?php _e('Transparency of overlay', 'tcd-horizon'); ?></span><input class="hankaku" style="width:70px;" type="number" max="1" min="0" step="0.1" name="dp_options[contents_builder][<?php echo $cb_index; ?>][overlay_opacity]" value="<?php echo esc_attr( $value['overlay_opacity'] ); ?>" />
     ...
     <div class="hide_when_type2_type3_type5">
      ...
      <div class="non_layout6_option">
       ...
       <input type="text" class="full_width cb-repeater-label" name="dp_options[contents_builder][<?php echo $cb_index; ?>][headline3]" value="<?php echo esc_html(  $value['headline3'] ); ?>" />
      ...
      <div class="layout6_option">
       ...
       <textarea class="full_width cb-repeater-label" cols="50" rows="3" name="dp_options[contents_builder][<?php echo $cb_index; ?>][catch3]"><?php echo esc_textarea(  $value['catch3'] ); ?></textarea>
       <ul class="option_list">
        <li class="cf">
         <span class="label"><?php _e('Font type', 'tcd-horizon');  ?></span>
         <div class="standard_radio_button">
          <?php foreach ( $font_type_options as $option ) { ?>
          <input id="catch_font_type3_<?php echo $cb_index; ?>_<?php echo esc_attr($option['value']); ?>" type="radio" name="dp_options[contents_builder][<?php echo $cb_index; ?>][catch_font_type3]" value="<?php echo esc_attr($option['value']); ?>"<?php checked( $value['catch_font_type3'], $option['value'] ); ?>>
        ...
        <li class="cf">
         ...
         <div class="font_size_option">
          <label class="font_size_label number_option">
           <input class="hankaku input_font_size" type="number" name="dp_options[contents_builder][<?php echo $cb_index; ?>][catch_font_size3]" value="<?php echo esc_attr( $value['catch_font_size3'] ); ?>" min="9" max="100" />
           <span class="icon icon_pc"></span>
          </label>
          <label class="font_size_label number_option">
           <input class="hankaku input_font_size" type="number" name="dp_options[contents_builder][<?php echo $cb_index; ?>][catch_font_size_sp3]" value="<?php echo esc_attr( $value['catch_font_size_sp3'] ); ?>" min="9" max="100" />
       ...
       <h4 class="theme_option_headline2"><?php _e('Description', 'tcd-horizon');  ?></h4>
       <textarea class="large-text" cols="50" rows="3" name="dp_options[contents_builder][<?php echo $cb_index; ?>][desc3]"><?php echo esc_textarea(  $value['desc3'] ); ?></textarea>

       <h4 class="theme_option_headline2"><?php _e('Button', 'tcd-horizon');  ?></h4>
       <p class="displayment_checkbox"><label><input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_button3]" type="checkbox" value="1" <?php checked( $value['show_button3'], 1 ); ?>><?php _e( 'Display button', 'tcd-horizon' ); ?></label></p>
        ...
        <ul class="option_list">
         ...
         <li class="cf"><span class="label">
          ...
          <div class="standard_radio_button">
           ...
           <input id="button_animation_type3_<?php echo esc_attr($option['value']); ?>_<?php echo $cb_index; ?>" type="radio" name="dp_options[contents_builder][<?php echo $cb_index; ?>][button_animation_type3]" value="<?php echo esc_attr($option['value']); ?>" <?php checked( $value['button_animation_type3'], $option['value'] ); ?>><label for="button_animation_type3_<?php echo esc_attr($option['value']); ?>_<?php echo $cb_index; ?>"><?php echo esc_html($option['label']); ?></label>
           <?php }; ?>
          </div>
         </li>
         <li class="cf"><span class="label"><?php _e('Color scheme', 'tcd-horizon'); ?></span><input type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][button_color3]" value="<?php echo esc_attr( $value['button_color3'] ); ?>" data-default-color="#00b200" class="c-color-picker"></li>
         <li class="cf"><span class="label"><?php _e('Color scheme on mouseover', 'tcd-horizon'); ?></span><input type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][button_color_hover3]" value="<?php echo esc_attr( $value['button_color_hover3'] ); ?>" data-default-color="#098700" class="c-color-picker"></li>
         <li class="cf"><span class="label"><?php _e('label', 'tcd-horizon'); ?></span><input class="full_width" type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][button_label3]" value="<?php echo esc_attr( $value['button_label3'] ); ?>" /></li>
         <li class="cf"><span class="label"><?php _e('URL', 'tcd-horizon'); ?></span><input class="full_width" type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][button_url3]" value="<?php echo esc_attr( $value['button_url3'] ); ?>"></li>
        </ul>
       </div>
   ...
   <div class="sub_box cf non_layout6_option">
    ...
    <div class="sub_box_content">
     ...
     <div class="cf" style="margin-top:20px;">
      <div class="standard_radio_button">
       <input type="radio" id="catch_type_type1_<?php echo $cb_index; ?>" name="dp_options[contents_builder][<?php echo $cb_index; ?>][catch_type]" value="type1"<?php checked( $value['catch_type'], 'type1' ); ?>>
       <label class="catch_type_type1_button" for="catch_type_type1_<?php echo $cb_index; ?>"><?php _e('Headline', 'tcd-horizon');  ?></label>
       <input type="radio" id="catch_type_type2_<?php echo $cb_index; ?>" name="dp_options[contents_builder][<?php echo $cb_index; ?>][catch_type]" value="type2"<?php checked( $value['catch_type'], 'type2' ); ?>>
       <label class="catch_type_type2_button" for="catch_type_type2_<?php echo $cb_index; ?>"><?php _e('Catchphrase', 'tcd-horizon');  ?></label>
      </div>
     </div>
     <br class="clear">

     <input type="text" class="catch_type1_area full_width cb-repeater-label" name="dp_options[contents_builder][<?php echo $cb_index; ?>][headline]" value="<?php echo esc_html(  $value['headline'] ); ?>" />
     <textarea class="catch_type2_area full_width" cols="50" rows="3" name="dp_options[contents_builder][<?php echo $cb_index; ?>][catch]"><?php echo esc_textarea(  $value['catch'] ); ?></textarea>
     ...
     <div class="hide_when_type4">
      ...
      <p class="displayment_checkbox"><label><input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_button]" type="checkbox" value="1" <?php checked( $value['show_button'], 1 ); ?>><?php _e( 'Display button', 'tcd-horizon' ); ?></label></p>
      <div class="button_option_area" style="<?php if($value['show_button'] == 1) { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
       <ul class="option_list">
        <li class="cf" style="border-top:1px dotted #ccc;"><span class="label"><?php _e('label', 'tcd-horizon');  ?></span><input class="full_width" type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][button_label]" value="<?php esc_attr_e( $value['button_label'] ); ?>" /></li>
        <li class="cf"><span class="label"><?php _e('URL', 'tcd-horizon');  ?></span><input class="full_width" type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][button_url]" value="<?php esc_attr_e( $value['button_url'] ); ?>" /></li>
       </ul>
      </div>
     </div>
     ...
     <h4 class="theme_option_headline2"><?php _e('Color', 'tcd-horizon');  ?></h4>
     <ul class="option_list">
      <li class="cf"><span class="label"><?php _e('Font color', 'tcd-horizon'); ?></span><input type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][font_color]" value="<?php echo esc_attr( $value['font_color'] ); ?>" data-default-color="#000000" class="c-color-picker"></li>
      <li class="cf color_picker_bottom"><span class="label"><?php _e('Background color', 'tcd-horizon'); ?></span><input type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][bg_color]" value="<?php echo esc_attr( $value['bg_color'] ); ?>" data-default-color="#ffffff" class="c-color-picker"></li>
     </ul>
       ...
       <li class="cf image_option2">
        ...
        <div class="image_box cf">
         <div class="cf cf_media_field hide-if-no-js image-<?php echo $cb_index; ?>4">
          <input type="hidden" class="cf_media_id" name="dp_options[contents_builder][<?php echo $cb_index; ?>][image4]" id="image-<?php echo $cb_index; ?>4" value="<?php echo esc_attr( $value['image4'] ); ?>">
       ...
       <li class="cf image_option2">
        ...
        <div class="image_box cf">
         <div class="cf cf_media_field hide-if-no-js image_mobile-<?php echo $cb_index; ?>4">
          <input type="hidden" class="cf_media_id" name="dp_options[contents_builder][<?php echo $cb_index; ?>][image_mobile4]" id="image_mobile-<?php echo $cb_index; ?>4" value="<?php echo esc_attr( $value['image_mobile4'] ); ?>">
...
?>
  ...
  <div class="cb_content">
   ...
   <p class="displayment_checkbox"><label><input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_content]" type="checkbox" value="1" <?php checked( $value['show_content'], 1 ); ?>> <?php _e('Display image slider', 'tcd-horizon'); ?></label></p>
   <div style="<?php if($value['show_content'] == 1) { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
   ...
   <ul class="design_radio_button2 cb_slider_layout_option" style="margin-bottom:30px;">
    <li<?php if($value['layout'] == 'type1'){ echo ' class="active"'; }; ?>>
     <label class="cb_slider_layout_option_type1" for="cb_slider_layout_type1_<?php echo $cb_index; ?>">
      ...
      <input type="radio" id="cb_slider_layout_type1_<?php echo $cb_index; ?>" name="dp_options[contents_builder][<?php echo $cb_index; ?>][layout]" value="type1" <?php checked( $value['layout'], 'type1' ); ?> />
     </label>
    </li>
    <li<?php if($value['layout'] == 'type2'){ echo ' class="active"'; }; ?>>
     <label class="cb_slider_layout_option_type2" for="cb_slider_layout_type2_<?php echo $cb_index; ?>">
      ...
      <input type="radio" id="cb_slider_layout_type2_<?php echo $cb_index; ?>" name="dp_options[contents_builder][<?php echo $cb_index; ?>][layout]" value="type2" <?php checked( $value['layout'], 'type2' ); ?> />
     </label>
    </li>
   </ul>
       ...
       <div class="sub_box repeater-item repeater-item-<?php echo esc_attr( $repeater_key ); ?>">
        ...
        <div class="sub_box_content">
         ...
         <div class="sub_box_tab_content active" data-tab-content="tab1">
            ...
            <li class="cf">
             ...
             <div class="image_box cf">
              <div class="cf cf_media_field hide-if-no-js image_slider_<?php echo $cb_index; ?>_image<?php echo esc_attr( $repeater_key ); ?>">
               <input type="hidden" value="<?php if ( $repeater_value['image'] ) echo esc_attr( $repeater_value['image'] ); ?>" id="image_slider_<?php echo $cb_index; ?>_image<?php echo esc_attr( $repeater_key ); ?>" name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_list][<?php echo esc_attr( $repeater_key ); ?>][image]" class="cf_media_id">
            ...
            <li class="cf">
             ...
             <div class="image_box cf">
              <div class="cf cf_media_field hide-if-no-js image_slider_<?php echo $cb_index; ?>_image<?php echo esc_attr( $repeater_key ); ?>_mobile">
               <input type="hidden" value="<?php if ( $repeater_value['image_mobile'] ) echo esc_attr( $repeater_value['image_mobile'] ); ?>" id="image_slider_<?php echo $cb_index; ?>_image<?php echo esc_attr( $repeater_key ); ?>_mobile" name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_list][<?php echo esc_attr( $repeater_key ); ?>][image_mobile]" class="cf_media_id">
           ...
           <ul class="option_list">
            <li class="cf"><span class="label"><?php _e('Color of overlay', 'tcd-horizon'); ?></span><input class="c-color-picker" type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_list][<?php echo esc_attr( $repeater_key ); ?>][overlay_color]" value="<?php echo esc_attr( $repeater_value['overlay_color'] ); ?>" data-default-color="#000000"></li>
            <li class="cf">
             <span class="label"><?php _e('Transparency of overlay', 'tcd-horizon'); ?></span><input class="hankaku" style="width:70px;" type="number" max="1" min="0" step="0.1" name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_list][<?php echo esc_attr( $repeater_key ); ?>][overlay_opacity]" value="<?php echo esc_attr( $repeater_value['overlay_opacity'] ); ?>" />
             <div class="theme_option_message2" style="clear:both; margin:7px 0 0 0;">
              <p><?php _e('Please specify the number of 0 from 0.9. Overlay color will be more transparent as the number is small.', 'tcd-horizon');  ?><br>
              <?php _e('Please enter 0 if you don\'t want to use overlay.', 'tcd-horizon');  ?></p>
             </div>
         ...
         <div class="sub_box_tab_content" data-tab-content="tab2">
           ...
           <?php // キャッチフレーズ ----------------------- ?>
           <h4 class="theme_option_headline2"><?php _e( 'Catchphrase', 'tcd-horizon' ); ?></h4>
           <textarea class="large-text" cols="50" rows="3" name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_list][<?php echo esc_attr( $repeater_key ); ?>][catch]"><?php echo esc_textarea(  $repeater_value['catch'] ); ?></textarea>
           <ul class="option_list">
            <li class="cf">
             <span class="label"><?php _e('Font type', 'tcd-horizon');  ?></span>
             <div class="standard_radio_button">
              <?php foreach ( $font_type_options as $option ) { ?>
              <input id="catch_font_type_<?php echo $cb_index; ?>_<?php echo esc_attr( $repeater_key ); ?>_<?php echo esc_attr($option['value']); ?>" type="radio" name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_list][<?php echo esc_attr( $repeater_key ); ?>][catch_font_type]" value="<?php echo esc_attr($option['value']); ?>"<?php checked( $repeater_value['catch_font_type'], $option['value'] ); ?>>
            ...
            <li class="cf">
             ...
             <div class="font_size_option">
              <label class="font_size_label number_option">
               <input class="hankaku input_font_size" type="number" name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_list][<?php echo esc_attr( $repeater_key ); ?>][catch_font_size]" value="<?php echo esc_attr( $repeater_value['catch_font_size'] ); ?>" min="9" max="100" />
               <span class="icon icon_pc"></span>
              </label>
              <label class="font_size_label number_option">
               <input class="hankaku input_font_size" type="number" name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_list][<?php echo esc_attr( $repeater_key ); ?>][catch_font_size_sp]" value="<?php echo esc_attr( $repeater_value['catch_font_size_sp'] ); ?>" min="9" max="100" />
               <span class="icon icon_sp"></span>
              </label>
             </div>
            </li>
           ...
           <h4 class="theme_option_headline2"><?php _e( 'Description', 'tcd-horizon' ); ?></h4>
           <textarea class="large-text" cols="50" rows="4" name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_list][<?php echo esc_attr( $repeater_key ); ?>][desc]"><?php echo esc_textarea(  $repeater_value['desc'] ); ?></textarea>
 
           <?php // ボタン ----------------------- ?>
           <h4 class="theme_option_headline2"><?php _e('Button', 'tcd-horizon');  ?></h4>
           <p class="hidden"><input name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_list][<?php echo esc_attr( $repeater_key ); ?>][show_button]" type="hidden" value="0"></p>
           <p class="displayment_checkbox"><label><input class="show_button" name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_list][<?php echo esc_attr( $repeater_key ); ?>][show_button]" type="checkbox" value="1" <?php checked( $repeater_value['show_button'], 1 ); ?>><?php _e( 'Display button', 'tcd-horizon' ); ?></label></p>
           <div style="<?php if($repeater_value['show_button'] == 1) { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
            <ul class="option_list">
             ...
             <li class="cf"><span class="label"><?php _e('Color scheme', 'tcd-horizon'); ?></span><input type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_list][<?php echo esc_attr( $repeater_key ); ?>][button_color]" value="<?php echo esc_attr( $repeater_value['button_color'] ); ?>" data-default-color="#00b200" class="c-color-picker"></li>
             <li class="cf"><span class="label"><?php _e('Color scheme on mouseover', 'tcd-horizon'); ?></span><input type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_list][<?php echo esc_attr( $repeater_key ); ?>][button_color_hover]" value="<?php echo esc_attr( $repeater_value['button_color_hover'] ); ?>" data-default-color="#098700" class="c-color-picker"></li>
             <li class="cf"><span class="label"><?php _e('label', 'tcd-horizon'); ?></span><input class="full_width" type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_list][<?php echo esc_attr( $repeater_key ); ?>][button_label]" value="<?php echo esc_attr( $repeater_value['button_label'] ); ?>" /></li>
             <li class="cf"><span class="label"><?php _e('URL', 'tcd-horizon'); ?></span><input class="full_width" type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_list][<?php echo esc_attr( $repeater_key ); ?>][button_url]" value="<?php echo esc_attr( $repeater_value['button_url'] ); ?>"></li>
            </ul>
           </div>
   ...
   <div class="sub_box cf">
    ...
    <div class="sub_box_content">
     ...
     <p class="displayment_checkbox"><label><input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_news_ticker]" type="checkbox" value="1" <?php checked( $value['show_news_ticker'], 1 ); ?>><?php _e( 'Display news ticker', 'tcd-horizon' ); ?></label></p>
     <div style="<?php if($value['show_news_ticker'] == 1) { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
      <ul class="option_list">
       <li class="cf" style="border-top:1px dotted #ccc;"><span class="label"><?php _e('Post type', 'tcd-horizon'); ?></span>
        <select name="dp_options[contents_builder][<?php echo $cb_index; ?>][news_ticker_post_type]">
       ...
       <li class="cf"><span class="label"><?php _e('Post order', 'tcd-horizon');  ?></span>
        <select name="dp_options[contents_builder][<?php echo $cb_index; ?>][news_ticker_post_order]">
   ...
   <div class="sub_box cf layout1_option">
    ...
    <div class="sub_box_content">
     ...
     <textarea style="margin-top:20px;" class="full_width" cols="50" rows="4" name="dp_options[contents_builder][<?php echo $cb_index; ?>][desc]"><?php echo esc_textarea(  $value['desc'] ); ?></textarea>
     <ul class="option_list">
      <li class="cf color_picker_bottom"><span class="label"><?php _e('Font color', 'tcd-horizon'); ?></span><input type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][desc_font_color]" value="<?php echo esc_attr( $value['desc_font_color'] ); ?>" data-default-color="#000000" class="c-color-picker"></li>
      <li class="cf color_picker_bottom"><span class="label"><?php _e('Background color', 'tcd-horizon'); ?></span><input type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][desc_bg_color]" value="<?php echo esc_attr( $value['desc_bg_color'] ); ?>" data-default-color="#ffffff" class="c-color-picker"></li>
     </ul>
...
<?php
     // ボックスコンテンツ -------------------------------------------------------------------------
       ...
       for ( $i = 1; $i <= 3; $i++ ) :
         ...
         if (!isset($value['image_mobile'.$i])) { $value['image_mobile'.$i] = false; }
...
?>
  ...
  <div class="cb_content">
   ...
   <p class="displayment_checkbox"><label><input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_content]" type="checkbox" value="1" <?php checked( $value['show_content'], 1 ); ?>> <?php _e('Display three box', 'tcd-horizon'); ?> (<a data-rel="lightcase" href="<?php bloginfo('template_url'); ?>/admin/img/cb_box.jpg"><?php _e('Sample', 'tcd-horizon'); ?></a>)</label></p>
   <div style="<?php if($value['show_content'] == 1) { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
   ...
   <div class="sub_box cf"> 
    ...
    <div class="sub_box_content">
     ...
     <ul class="design_radio_button horizontal cf">
      <li class="cb_bg_type_type1">
       <input type="radio" id="bg_type1_<?php echo $cb_index; ?>_<?php echo $i; ?>" name="dp_options[contents_builder][<?php echo $cb_index; ?>][bg_type<?php echo $i; ?>]" value="type1" <?php checked( $value['bg_type'.$i], 'type1' ); ?> />
       <label for="bg_type1_<?php echo $cb_index; ?>_<?php echo $i; ?>"><?php _e('Image', 'tcd-horizon'); ?></label>
      </li>
      <li class="cb_bg_type_type2">
       <input type="radio" id="bg_type2_<?php echo $cb_index; ?>_<?php echo $i; ?>" name="dp_options[contents_builder][<?php echo $cb_index; ?>][bg_type<?php echo $i; ?>]" value="type2" <?php checked( $value['bg_type'.$i], 'type2' ); ?> />
       <label for="bg_type2_<?php echo $cb_index; ?>_<?php echo $i; ?>"><?php _e('Video', 'tcd-horizon'); ?></label>
      </li>
      <li class="cb_bg_type_type3">
       <input type="radio" id="bg_type3_<?php echo $cb_index; ?>_<?php echo $i; ?>" name="dp_options[contents_builder][<?php echo $cb_index; ?>][bg_type<?php echo $i; ?>]" value="type3" <?php checked( $value['bg_type'.$i], 'type3' ); ?> />
       <label for="bg_type3_<?php echo $cb_index; ?>_<?php echo $i; ?>"><?php _e('Youtube', 'tcd-horizon'); ?></label>
      </li>
      <li class="cb_bg_type_type4">
       <input type="radio" id="bg_type4_<?php echo $cb_index; ?>_<?php echo $i; ?>" name="dp_options[contents_builder][<?php echo $cb_index; ?>][bg_type<?php echo $i; ?>]" value="type4" <?php checked( $value['bg_type'.$i], 'type4' ); ?> />
     ...
     <div class="video_bg_option">
      ...
      <div class="image_box cf">
       <div class="cf cf_media_field hide-if-no-js video_<?php echo $cb_index; ?>_<?php echo $i; ?>">
        <input type="hidden" value="<?php echo esc_attr( $value['video'.$i] ); ?>" id="video_<?php echo $cb_index; ?>_<?php echo $i; ?>" name="dp_options[contents_builder][<?php echo $cb_index; ?>][video<?php echo $i; ?>]" class="cf_media_id">
        <div class="preview_field preview_field_video">
     ...
     <div class="youtube_bg_option">
      ...
      <input class="regular-text" type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][youtube<?php echo $i; ?>]" value="<?php echo esc_attr( $value['youtube'.$i] ); ?>">
      ...
      <li class="cf">
       ...
       <div class="image_box cf">
        <div class="cf cf_media_field hide-if-no-js image<?php echo $i; ?>-<?php echo $cb_index; ?>">
         <input type="hidden" class="cf_media_id" name="dp_options[contents_builder][<?php echo $cb_index; ?>][image<?php echo $i; ?>]" id="image<?php echo $i; ?>-<?php echo $cb_index; ?>" value="<?php echo esc_attr( $value['image'.$i] ); ?>">
      ...
      <li class="cf image_bg_option">
       ...
       <div class="image_box cf">
        <div class="cf cf_media_field hide-if-no-js image_mobile<?php echo $i; ?>-<?php echo $cb_index; ?>">
         <input type="hidden" class="cf_media_id" name="dp_options[contents_builder][<?php echo $cb_index; ?>][image_mobile<?php echo $i; ?>]" id="image_mobile<?php echo $i; ?>-<?php echo $cb_index; ?>" value="<?php echo esc_attr( $value['image_mobile'.$i] ); ?>">
     ...
     <p><label><input class="use_para_checkbox" name="dp_options[contents_builder][<?php echo $cb_index; ?>][use_para<?php echo $i; ?>]" type="checkbox" value="1" <?php checked( $value['use_para'.$i], 1 ); ?>><?php _e( 'Use parallax effect', 'tcd-horizon' ); ?></label></p>

     <h4 class="theme_option_headline2"><span class="image_bg_option"><?php _e( 'Overlay for image', 'tcd-horizon' ); ?></span><span class="video_bg_option"><?php _e( 'Overlay for video', 'tcd-horizon' ); ?></span><span class="youtube_bg_option"><?php _e( 'Overlay for video', 'tcd-horizon' ); ?></span></h4>
     <ul class="option_list">
      <li class="cf"><span class="label"><?php _e('Color of overlay', 'tcd-horizon'); ?></span><input type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][overlay_color<?php echo $i; ?>]" value="<?php echo esc_attr( $value['overlay_color'.$i] ); ?>" data-default-color="#000000" class="c-color-picker"></li>
      <li class="cf">
       <span class="label"><?php _e('Transparency of overlay', 'tcd-horizon'); ?></span><input class="hankaku" style="width:70px;" type="number" max="1" min="0" step="0.1" name="dp_options[contents_builder][<?php echo $cb_index; ?>][overlay_opacity<?php echo $i; ?>]" value="<?php echo esc_attr( $value['overlay_opacity'.$i] ); ?>" />
       <div class="theme_option_message2" style="clear:both; margin:7px 0 0 0;">
        <p><?php _e('Please specify the number of 0 from 0.9. Overlay color will be more transparent as the number is small.', 'tcd-horizon');  ?><br>
        <?php _e('Please enter 0 if you don\'t want to use overlay.', 'tcd-horizon');  ?></p>
       </div>
     ...
     <div class="color_bg_option">
      ...
      <div class="color_picker_bottom"><input type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][bg_color<?php echo $i; ?>]" value="<?php echo esc_attr( $value['bg_color'.$i] ); ?>" data-default-color="<?php if($i == 1){ echo '#ffffff'; } elseif($i == 2){ echo '#555555'; } else { echo '#f6f7f8'; }; ?>" class="c-color-picker"></div>
     </div>
     ...
     <h4 class="theme_option_headline2"><?php _e('Headline', 'tcd-horizon');  ?></h4>
     <input type="text" class="full_width" name="dp_options[contents_builder][<?php echo $cb_index; ?>][headline<?php echo $i; ?>]" value="<?php echo esc_html(  $value['headline'.$i] ); ?>" />

     <h4 class="theme_option_headline2"><?php _e('Description', 'tcd-horizon');  ?></h4>
     <div class="theme_option_message2">
      <p><?php _e('If it is a plan etc., please describe the outline here.', 'tcd-horizon');  ?></p>
     </div>
     <textarea class="large-text" cols="50" rows="3" name="dp_options[contents_builder][<?php echo $cb_index; ?>][desc_top<?php echo $i; ?>]"><?php echo esc_textarea(  $value['desc_top'.$i] ); ?></textarea>
     ...
     <textarea class="large-text" cols="50" rows="3" name="dp_options[contents_builder][<?php echo $cb_index; ?>][desc_middle<?php echo $i; ?>]"><?php echo esc_textarea(  $value['desc_middle'.$i] ); ?></textarea>
     ...
     <textarea class="large-text" cols="50" rows="3" name="dp_options[contents_builder][<?php echo $cb_index; ?>][desc_bottom<?php echo $i; ?>]"><?php echo esc_textarea(  $value['desc_bottom'.$i] ); ?></textarea>

     <h4 class="theme_option_headline2"><?php _e('Text color', 'tcd-horizon');  ?></h4>
     <div class="color_picker_bottom"><input type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][font_color<?php echo $i; ?>]" value="<?php echo esc_attr( $value['font_color'.$i] ); ?>" data-default-color="<?php if($i == 1){ echo '#ffffff'; } elseif($i == 2){ echo '#ffffff'; } else { echo '#000000'; }; ?>" class="c-color-picker"></div>
...
?>
  ...
  <div class="cb_content">
   ...
   <p class="displayment_checkbox"><label><input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_content]" type="checkbox" value="1" <?php checked( $value['show_content'], 1 ); ?>> <?php _e('Display access map', 'tcd-horizon'); ?> (<a data-rel="lightcase" href="<?php bloginfo('template_url'); ?>/admin/img/cb_access.jpg"><?php _e('Sample', 'tcd-horizon'); ?></a>)</label></p>
   <div style="<?php if($value['show_content'] == 1) { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
   ...
   <input type="text" class="full_width" name="dp_options[contents_builder][<?php echo $cb_index; ?>][address]" value="<?php echo esc_html(  $value['address'] ); ?>" />
   ...
   <p><label><input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_logo]" type="checkbox" value="1" <?php checked( $value['show_logo'], 1 ); ?>><?php _e( 'Display logo', 'tcd-horizon' ); ?></label></p>
   ...
   <p><label><input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_sns]" type="checkbox" value="1" <?php checked( $value['show_sns'], 1 ); ?>><?php _e( 'Display SNS icon', 'tcd-horizon' ); ?></label></p>

   <h4 class="theme_option_headline2"><?php _e('Background color', 'tcd-horizon'); ?></h4>
   <div class="color_picker_bottom"><input type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][bg_color]" value="<?php echo esc_attr( $value['bg_color'] ); ?>" data-default-color="#f3f3f3" class="c-color-picker"></div>
...
<?php
     // フリースペース　-------------------------------------------------------------
       ...
       if (!isset($value['padding_mobile'])) { $value['padding_mobile'] = '0'; }

?>
  <h3 class="cb_content_headline"><?php _e('Free space', 'tcd-horizon');  ?></h3>
  <div class="cb_content">

   <p class="displayment_checkbox"><label><input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_content]" type="checkbox" value="1" <?php checked( $value['show_content'], 1 ); ?>> <?php _e('Display free space', 'tcd-horizon'); ?></label></p>
   <div style="<?php if($value['show_content'] == 1) { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
   ...
   <ul class="option_list">
    <li class="cf"><span class="label"><?php _e('Space around content', 'tcd-horizon'); ?></span><input class="font_size hankaku" type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][padding]" value="<?php esc_attr_e( $value['padding'] ); ?>" /><span>px</span></li>
    <li class="cf"><span class="label"><?php _e('Space around content (mobile)', 'tcd-horizon'); ?></span><input class="font_size hankaku" type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][padding_mobile]" value="<?php esc_attr_e( $value['padding_mobile'] ); ?>" /><span>px</span></li>
   </ul>
