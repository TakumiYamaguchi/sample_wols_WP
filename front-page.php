...
?>
    <div class="cb_design_content num<?php echo $content_count; ?> layout_<?php echo esc_attr($layout); ?>"
        id="<?php echo 'cb_content_' . $content_count; ?>">

        <?php // �����̃R���e���c ---------------------------------- ?>
        <?php if($layout == 'type5'){ ?>
        <div class="content content3"
            style="background-color:<?php echo esc_attr($content['bg_color2']); ?>; color:<?php echo esc_attr($content['font_color2']); ?>;">

            <div class="content_inner">
                <?php if($content['catch_type2'] == 'type1' && $content['headline2']){ ?>
                <h2 class="headline common_headline rich_font_<?php echo esc_attr($options['headline_font_type']); ?>">
                    <?php echo wp_kses_post(nl2br($content['headline2'])); ?></h2>
                <?php }; ?>
                ...
                <p
                    class="desc<?php if(empty($content['headline2']) && empty($content['catch2'])){ echo ' no_headline'; }; ?>">
                    <?php echo wp_kses_post(nl2br($content['desc2'])); ?></p>
                <?php }; ?>
                <?php if($content['show_button2']){ ?>
                <div class="link_button">
                    <a class="design_button"
                        href="<?php echo esc_url($content['button_url2']); ?>"><span><?php echo esc_html($content['button_label2']); ?></span></a>
                </div>
                <?php }; ?>
            </div>
        ...
        <?php // �����̃R���e���c ---------------------------------- ?>
        <div
            class="content content1<?php if($bg_type == 'type3'){ echo ' youtube_bg'; if ( !empty($content['use_para']) && !is_mobile() ) { echo ' youtube_bg_parallax'; }; }; ?>">
            ...
            <div class="content_inner">
                ...
                <h2 class="headline common_headline rich_font_<?php echo esc_attr($options['headline_font_type']); ?>">
                    <?php echo wp_kses_post(nl2br($content['headline3'])); ?></h2>
                <?php }; ?>

                <?php } else { ?>

                <?php if($content['catch3']){ ?>
                <h2 class="catch rich_font_<?php echo esc_attr($content['catch_font_type3']); ?>">
                    <?php echo wp_kses_post(nl2br($content['catch3'])); ?></h2>
                <?php }; ?>
                ...
                <div class="link_button">
                    <a class="design_button"
                        href="<?php echo esc_url($content['button_url3']); ?>"><span><?php echo esc_html($content['button_label3']); ?></span></a>
                </div>
                <?php }; ?>
  ...
  ?>
            <div class="overlay"
                style="background-color:rgba(<?php echo esc_attr($overlay_color); ?>,<?php echo esc_attr($overlay_opacity); ?>);">
            </div>
            <?php }; ?>
            ...
            <div class="image image1" data-parallax-image="<?php echo esc_attr( $image1[0] ); ?>"
                <?php if ($image_mobile1) echo ' data-parallax-mobile-image="' . esc_attr( $image_mobile1[0] ) . '"'; ?>>
            </div>
            <?php } else { ?>
            <?php if($image1){ ?>
            <div class="image image1<?php if($image_mobile1){ echo ' pc'; }; ?>"
                style="background:url(<?php echo esc_attr($image1[0]); ?>) no-repeat center center; background-size:cover;">
            </div>
            <?php if($image_mobile1){ ?>
            <div class="image image1 mobile"
                style="background:url(<?php echo esc_attr($image_mobile1[0]); ?>) no-repeat center center; background-size:cover;">
            </div>
            <?php }; ?>
            <?php }; ?>
            <?php }; ?>
            ...
            <div class="image image2" data-parallax-image="<?php echo esc_attr( $image2[0] ); ?>"
                <?php if ($image_mobile2) echo ' data-parallax-mobile-image="' . esc_attr( $image_mobile2[0] ) . '"'; ?>>
            </div>
            <?php } else { ?>
            <?php if($image2){ ?>
            <div class="image image2<?php if($image_mobile2){ echo ' pc'; }; ?>"
                style="background:url(<?php echo esc_attr($image2[0]); ?>) no-repeat center center; background-size:cover;">
            </div>
            <?php if($image_mobile2){ ?>
            <div class="image image2 mobile"
                style="background:url(<?php echo esc_attr($image_mobile2[0]); ?>) no-repeat center center; background-size:cover;">
            </div>
            <?php }; ?>
            <?php }; ?>
            <?php }; ?>
            ...
            <div class="image image3" data-parallax-image="<?php echo esc_attr( $image3[0] ); ?>"
                <?php if ($image_mobile3) echo ' data-parallax-mobile-image="' . esc_attr( $image_mobile3[0] ) . '"'; ?>>
            </div>
            <?php } else { ?>
            <?php if($image3){ ?>
            <div class="image image3<?php if($image_mobile3){ echo ' pc'; }; ?>"
                style="background:url(<?php echo esc_attr($image3[0]); ?>) no-repeat center center; background-size:cover;">
            </div>
            <?php if($image_mobile3){ ?>
            <div class="image image3 mobile"
                style="background:url(<?php echo esc_attr($image_mobile3[0]); ?>) no-repeat center center; background-size:cover;">
            </div>
            <?php }; ?>
            <?php }; ?>
            <?php }; ?>
         ...
         if(!empty($video)) {
           if (auto_play_movie()) {
  ?>
            <video class="video<?php if ( !empty($content['use_para']) && !is_mobile() ) echo ' video_parallax'; ?>"
                src="<?php echo esc_url(wp_get_attachment_url($video)); ?>" playsinline autoplay loop muted></video>
            <?php
           } else {
             if($image1){
  ?>
  ...
  ?>
            <div class="youtube_wrap">
                <div class="youtube_inner">
                    <iframe class="youtube_item"
                        src="https://www.youtube.com/embed/<?php echo esc_attr($matches[1]); ?>?enablejsapi=1&controls=0&fs=0&iv_load_policy=3&rel=0&showinfo=0&autoplay=1&mute=1&loop=1&<?php echo "playlist=" . esc_attr($matches[1]); ?>&playsinline=1"
  ...
  ?>
        ...
        <div class="content content2"
            style="background-color:<?php echo esc_attr($content['bg_color']); ?>; color:<?php echo esc_attr($content['font_color']); ?>;">
            ...
            <div class="content_top">
                ...
                <div class="content_inner">
                    ...
                    <h2
                        class="headline common_headline rich_font_<?php echo esc_attr($options['headline_font_type']); ?>">
                        <?php echo wp_kses_post(nl2br($content['headline'])); ?></h2>
                    <?php }; ?>
                    ...
                    <?php if($content['desc']){ ?>
                    <p
                        class="desc<?php if(empty($content['headline']) && empty($content['catch'])){ echo ' no_headline'; }; ?>">
                        <?php echo wp_kses_post(nl2br($content['desc'])); ?></p>
                    <?php }; ?>
                    <?php if($content['show_button']){ ?>
                    <div class="link_button">
                        <a class="design_button"
                            href="<?php echo esc_url($content['button_url']); ?>"><span><?php echo esc_html($content['button_label']); ?></span></a>
                    </div>
                    <?php }; ?>
                </div>
                <?php if($layout == 'type4'){ ?>
            ...
            <div class="image image4<?php if($image_mobile4){ echo ' pc'; }; ?>"
                style="background:url(<?php echo esc_attr($image4[0]); ?>) no-repeat center center; background-size:cover;">
            </div>
            <?php if($image_mobile4){ ?>
            <div class="image image4 mobile"
                style="background:url(<?php echo esc_attr($image_mobile4[0]); ?>) no-repeat center center; background-size:cover;">
            </div>
            <?php }; ?>
            <?php }; ?>
    ...
    <?php
         // �摜�X���C�_�[ -----------------------------------------------------
           ...
           $layout = isset($content['layout']) ? $content['layout'] : 'type1';
?>
    <div class="cb_image_slider num<?php echo $content_count; ?> layout_<?php echo esc_attr($layout); ?><?php if(!$content['show_news_ticker']){ echo ' no_news_ticker'; }; ?>"
        id="<?php echo 'cb_content_' . $content_count; ?>">
   ...
   ?>
                <div class="item item<?php echo $i; ?> <?php if($i == 1){ echo 'first_item'; }; ?>">
                    ...
                    <div class="caption">
                        ...
                        <h3 class="catch animate_item rich_font_<?php echo esc_attr($value['catch_font_type']); ?>">
                            <img class="top_wols_logo"
                                src="<?php echo get_template_directory_uri();?>/img/common/wols_log.png" alt="wols">
                            <!-- <?php echo wp_kses_post(nl2br($value['catch'])); ?> -->
                        ...
                        <div class="button animate_item">
                            <a class="slider_design_button"
                                href="<?php echo esc_url($value['button_url']); ?>"><span><?php echo esc_html($value['button_label']); ?></span></a>
                        </div>
                        <?php }; ?>
                    ...
                    <?php if($image) { ?><div class="bg_image <?php if($image_mobile) { echo 'pc'; }; ?>"
                        style="background:url(<?php echo esc_attr($image[0]); ?>) no-repeat center center; background-size:cover;">
                    </div><?php }; ?>
                    <?php if($image_mobile) { ?><div class="bg_image mobile"
                        style="background:url(<?php echo esc_attr($image_mobile[0]); ?>) no-repeat center center; background-size:cover;">
                    </div><?php }; ?>
                    ...
                    <article class="item">
                        <a href="<?php the_permalink(); ?>">
                            <time class="date entry-date published"
                                datetime="<?php the_modified_time('c'); ?>"><?php the_time('Y.m.d'); ?></time>
 ...
 ?>
        <div class="desc_area"
            style="background-color:<?php echo esc_attr($content['desc_bg_color']); ?>; color:<?php echo esc_attr($content['desc_font_color']); ?>;">
...
?>
 ...
 ?>
        <div class="content num<?php echo $i; if($bg_type == 'type3'){ echo ' youtube_bg'; if ( !empty($content['use_para' . $i]) && !is_mobile() ) { echo ' youtube_bg_parallax'; }; }; ?>"
            style="background-color:<?php echo esc_attr($content['bg_color'.$i]); ?>; color:<?php echo esc_attr($content['font_color'.$i]); ?>;">
            ...
            <div class="mobile_content_wrap">
                ...
                <div class="content_inner">
                    ...
                    <h2
                        class="headline common_headline rich_font_<?php echo esc_attr($options['headline_font_type']); ?>">
                        <?php echo wp_kses_post(nl2br($content['headline'.$i])); ?></h2>
                    <?php }; ?>
  ...
  ?>
            ...
            <div class="image" data-parallax-image="<?php echo esc_attr( $image[0] ); ?>"
                <?php if ($image_mobile) echo ' data-parallax-mobile-image="' . esc_attr( $image_mobile[0] ) . '"'; ?>>
            </div>
            <?php } else { ?>
            <?php if($image){ ?>
            <div class="image<?php if($image_mobile){ echo ' pc'; }; ?>"
                style="background:url(<?php echo esc_attr($image[0]); ?>) no-repeat center center; background-size:cover;">
            </div>
            <?php if($image_mobile){ ?>
         ...
         if(!empty($video)) {
           if (auto_play_movie()) {
  ?>
            <video class="video<?php if ( !empty($content['use_para' . $i]) && !is_mobile()) echo ' video_parallax'; ?>"
                src="<?php echo esc_url(wp_get_attachment_url($video)); ?>" playsinline autoplay loop muted></video>
            <?php
           } else {
             if($image){
 ...
 ?>
   ...
   ?>
                <ul class="sns_button_list clearfix color_<?php echo esc_attr($options['sns_button_color_type']); ?>">
                    <?php if($insta) { ?><li class="insta"><a href="<?php echo esc_url($insta); ?>"
                            rel="nofollow noopener" target="_blank" title="Instagram"><span>Instagram</span></a></li>
                    <?php }; ?>
                    <?php if($twitter) { ?><li class="twitter"><a href="<?php echo esc_url($twitter); ?>"
                            rel="nofollow noopener" target="_blank" title="Twitter"><span>Twitter</span></a></li>
                    <?php }; ?>
                    ...
                    <?php if($contact) { ?><li class="contact"><a href="<?php echo esc_url($contact); ?>"
                            rel="nofollow noopener" target="_blank" title="Contact"><span>Contact</span></a></li>
                    <?php }; ?>
                </ul>
                <?php }; ?>
