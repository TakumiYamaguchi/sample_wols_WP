...
<!DOCTYPE html>
<html
    class="pc<?php if( (is_single() && !is_singular('work')) || (is_page() && !is_page_template('page-about.php') && !is_front_page()) || is_404() ){ echo ' show_scroll_y'; } else { echo ' hide_scroll_y'; }; ?>"
...
?>
    <div id="header_message"
        style="color:<?php esc_attr_e($font_color); ?>;background-color:<?php esc_attr_e($bg_color); ?>;">
        <?php if($url){ ?>
