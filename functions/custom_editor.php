...
function tcd_add_quicktags() {
	...
	$tcdQuicktagsL10n = array(
		'pulldown_title' => array(
			'display' => __( 'quicktags', 'tcd-horizon' ),
		),
		'ytube' => array(
			'display' => __( 'YouTube', 'tcd-horizon' ),
			'tag' => __( '<div class="ytube">YouTube code here</div>', 'tcd-horizon' )
		),
		'relatedcardlink' => array(
			'display' => __( 'Cardlink', 'tcd-horizon' ),
			'tag' => __( '[clink url="Post URL to display"]', 'tcd-horizon' )
		),
		'post_col-2' => array(
			'display' => __( '2 column', 'tcd-horizon' ),
			'tag' => __( '<div class="post_row"><div class="post_col post_col-2">Text and image tags to display in the left column</div><div class="post_col post_col-2">Text and image tags to display in the right column</div></div>', 'tcd-horizon' )
		),
		'post_col-3' => array(
			'display' => __( '3 column', 'tcd-horizon' ),
			'tag' => __( '<div class="post_row"><div class="post_col post_col-3">Text and image tags to display in the left column</div><div class="post_col post_col-3">Text and image tags to display in the center column</div><div class="post_col post_col-3">Text and image tags to display in the right column</div></div>', 'tcd-horizon' )
		),
		'q_comment_out' => array(
			'display' => __( 'Comment out', 'tcd-horizon' ),
			'tag' => '<div class="hidden"><!-- ' . __( 'Text entered in this area will not be displayed on the browser', 'tcd-horizon' ) . ' --></div>'
		),
		'q_h2' => array(
			'display' => __( 'Styled h2 tag', 'tcd-horizon' ),
			'tag' => '<h2 class="styled_h2">' . __( 'Heading 2', 'tcd-horizon' ) . '</h2>'
		),
		'q_h3' => array(
			'display' => __( 'Styled h3 tag', 'tcd-horizon' ),
			'tag' => '<h3 class="styled_h3">' . __( 'Heading 3', 'tcd-horizon' ) . '</h3>'
		),
		'q_h4' => array(
			'display' => __( 'Styled h4 tag', 'tcd-horizon' ),
			'tag' => '<h4 class="styled_h4">' . __( 'Heading 4', 'tcd-horizon' ) . '</h4>'
		),
		'q_h5' => array(
			'display' => __( 'Styled h5 tag', 'tcd-horizon' ),
			'tag' => '<h5 class="styled_h5">' . __( 'Heading 5', 'tcd-horizon' ) . '</h5>'
		),
		'well2' => array(
			'display' => __( 'Frame style', 'tcd-horizon' ),
			'tag' => __( '<p class="well2">Frame style</p>', 'tcd-horizon' )
		),
		'q_custom_button1' => array(
			'display' => sprintf( __( 'Button %d', 'tcd-horizon' ), 1 ),
			'tag' => '<a href="#" class="q_custom_button q_custom_button1">' . sprintf( __( 'Button %d', 'tcd-horizon' ), 1 ) . '</a>'
		),
		'q_custom_button2' => array(
			'display' => sprintf( __( 'Button %d', 'tcd-horizon' ), 2 ),
			'tag' => '<a href="#" class="q_custom_button q_custom_button2">' . sprintf( __( 'Button %d', 'tcd-horizon' ), 2 ) . '</a>'
		),
		'q_custom_button3' => array(
			'display' => sprintf( __( 'Button %d', 'tcd-horizon' ), 3 ),
			'tag' => '<a href="#" class="q_custom_button q_custom_button3">' . sprintf( __( 'Button %d', 'tcd-horizon' ), 3 ) . '</a>'
		),
		'q_underline1' => array(
			'display' => sprintf( __( 'Underline %d', 'tcd-horizon' ), 1 ),
			'tag' => '<span class="q_underline q_underline1" style="border-bottom-color:;">' . sprintf( __( 'Underline %d', 'tcd-horizon' ), 1 ) . '</span>'
		),
		'q_underline2' => array(
			'display' => sprintf( __( 'Underline %d', 'tcd-horizon' ), 2 ),
			'tag' => '<span class="q_underline q_underline2" style="border-bottom-color:;">' . sprintf( __( 'Underline %d', 'tcd-horizon' ), 2 ) . '</span>'
		),
		'q_underline3' => array(
			'display' => sprintf( __( 'Underline %d', 'tcd-horizon' ), 3 ),
			'tag' => '<span class="q_underline q_underline3" style="border-bottom-color:;">' . sprintf( __( 'Underline %d', 'tcd-horizon' ), 3 ) . '</span>'
		),
		'speech_balloon_left1' => array(
			'display' => __( 'Speech balloon left 1', 'tcd-horizon' ),
			'tag' => '[speech_balloon_left1]'.__( 'Enter the text in the speech balloon here.', 'tcd-horizon' ).'[/speech_balloon_left1]'
		),
		'speech_balloon_left2' => array(
			'display' => __( 'Speech balloon left 2', 'tcd-horizon' ),
			'tag' => '[speech_balloon_left2]'.__( 'Enter the text in the speech balloon here.', 'tcd-horizon' ).'[/speech_balloon_left2]'
		),
		'speech_balloon_right1' => array(
			'display' => __( 'Speech balloon right 1', 'tcd-horizon' ),
			'tag' => '[speech_balloon_right1]'.__( 'Enter the text in the speech balloon here.', 'tcd-horizon' ).'[/speech_balloon_right1]'
		),
		'speech_balloon_right2' => array(
			'display' => __( 'Speech balloon right 2', 'tcd-horizon' ),
			'tag' => '[speech_balloon_right2]'.__( 'Enter the text in the speech balloon here.', 'tcd-horizon' ).'[/speech_balloon_right2]'
		),
		'google_map' => array(
			'display' => __( 'Google map' ),
			'tag' => '[qt_google_map address="'. __( 'Enter address here', 'tcd-horizon' ) . '"]'
		)
	);
?>
...
<?php
	...
	switch ($button_size){
		...
		case 'medium': $size = 'min-width:270px; height:60px; line-height:60px;'; break;
