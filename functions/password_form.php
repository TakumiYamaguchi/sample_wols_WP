...
function pw_meta_box() {
	...
	add_meta_box(
		...
		__( 'Contents to encourage member registration', 'tcd-horizon' ), // label
...
<div class="tcd_custom_fields">
 ...
 <div class="tcd_cf_content">
  <select name="pw_content">
   <option value=""><?php _e( 'Select a content to encourage member registration.', 'tcd-horizon' ); ?></option>
   <?php for ( $i = 1; $i <= 3; $i++ ) : ?>
...
function tcd_password_form() {
	...
	if ( ! $pw_content ) {
		...
		$output .= '<div><label class="c-pw__box-label" for="' . $label . '">' . __( 'Password:', 'tcd-horizon' ) . '</label><input class="c-pw__box-input" name="post_password" id="' . $label . '" type="password" size="20"><input class="c-pw__btn c-pw__btn--submit" type="submit" name="Submit" value="' . esc_attr( __( 'Submit' ) ) . '"></div>';
