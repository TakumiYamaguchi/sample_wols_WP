...
function add_custom_meta_boxes() {
 add_meta_box(
  ...
  __('Recommend post', 'tcd-horizon'),//label
...
?>
<p><?php _e('This option will be used in widget and other content.', 'tcd-horizon');  ?></p>
<ul>
 <li><label><input type="checkbox" name="recommend_post" value="on" <?php if( $recommend_post == 'on' ) { ?>checked="checked"<?php } ?> />  <?php _e('Show this post for recommend post1', 'tcd-horizon');  ?></label></li>
 <li><label><input type="checkbox" name="recommend_post2" value="on" <?php if( $recommend_post2 == 'on' ) { ?>checked="checked"<?php } ?> />  <?php _e('Show this post for recommend post2', 'tcd-horizon');  ?></label></li>
 <li><label><input type="checkbox" name="recommend_post3" value="on" <?php if( $recommend_post3 == 'on' ) { ?>checked="checked"<?php } ?> />  <?php _e('Show this post for recommend post3', 'tcd-horizon');  ?></label></li>
</ul>
<?php
}
