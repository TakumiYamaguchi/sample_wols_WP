...
function update_notifier_menu() {
	...
	if ( version_compare( $theme_data['Version'], $xml->latest ) == -1 ) {
		add_dashboard_page( $theme_data['Name'] . ' Theme Updates', __( 'Theme Update', 'tcd-horizon' ) . '<span class="update-plugins count-1"><span class="update-count">1</span></span>', 'administrator', 'design-plus-updates', 'update_notifier' );
	}
}
...
?>
    ...
    <div class="wrap">
   		...
   		<h2><?php echo $theme_data['Name']; ?> <?php _e( 'Theme Update Information', 'tcd-horizon' ); ?></h2>
   		<div id="message" class="updated below-h2">
   			<p><strong><?php printf( __( 'The latest version of %s is released.', 'tcd-horizon' ), esc_html( $theme_data['Name'] ) ); ?></strong> <?php printf( __( 'Current version is %s. You can update to the latest version, %s.', 'tcd-horizon' ), esc_html( $theme_data['Version'] ), esc_html( $xml->latest ) ); ?></p>
     	</div>
     	<div id="mono_instructions">
				<h3><?php _e( 'Note: Please be sure to backup your theme before you update to the latest version.', 'tcd-horizon' ); ?></h3>
        <p style="font-size:16px;">【 <a href="https://tcd.style/login" rel="noopener" target="_blank"><?php _e( 'Download the latest theme from My Page', 'tcd-horizon' ); ?></a> 】<br /><span style="font-size:14px;"><?php _e( 'Click <a href="https://tcd-theme.com/2017/01/theme_update.html" rel="noopener" target="_blank">here</a> to find out how to update the theme.', 'tcd-horizon' ); ?></span></p>
     		<div id="mono_info">
   				<h3><?php _e( 'Changelog', 'tcd-horizon' ); ?></h3>
...
function get_latest_theme_version( $interval ) {
    ...
    $notifier_file_url = 'http://design-plus1.com/notifier_horizon.xml';
    $db_cache_field = 'horizon-contempo-notifier-cache';
    $db_cache_field_last_updated = 'horizon-contempo-notifier-last-updated';
