...
<div class="custom_category_meta" style="margin:20px 0;">
 <h3 class="ccm_headline"><?php _e( 'Additional user data', 'tcd-horizon' ); ?></h3>
...
<?php
	...
	// 以下全ユーザー
?>
  <h4 class="headline"><?php _e( 'Profile image', 'tcd-horizon' ); ?></h4>
  <div class="input_field">
   <p><?php printf(__('Recommend image size. Width:%1$spx, Height:%2$spx.', 'tcd-horizon'), '360', '360'); ?></p>
